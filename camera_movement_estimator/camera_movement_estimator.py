...
from utils import mesure_distance, measure_xy_distance  # Correction ici

class CameraMovementEstimator(object):
    def __init__(self, frame):
        ...
        mask_features[:, width - 20:width] = 1
        ...
        for object_id, object_tracks in tracks.items():
            for frame_num, track in enumerate(object_tracks):
                for track_id, track_data in track.items():
                    ...
                    tracks[object_id][frame_num][track_id]["position_adjusted"] = position_adjusted

    def get_camera_movement(self, frames, read_from_stub=False, stub_path=None):
        # Read the stub if read_from_stub and stub_path is not None and os.path.exists
        ...
        for frame_num in range(1, len(frames)):
            ...
            if old_features is None or old_features.shape[0] == 0:
            ...
            for i, (new, old) in enumerate(zip(new_features, old_features)):
                ...
                distance = mesure_distance(new_features_point, old_features_point)  # Correction ici
