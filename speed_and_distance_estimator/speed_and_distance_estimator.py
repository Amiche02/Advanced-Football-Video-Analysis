...
from utils import mesure_distance, get_foot_position

class SpeedAndDistanceEstimator(object):
    def __init__(self):
        self.frame_window = 5
        self.frame_rate = 24 # per second
        ...
        for object, object_tracks in tracks.items():
            ...
            for frame_num in range(0, number_of_frames, self.frame_window):
                ...
                for track_id, _ in object_tracks[frame_num].items():
                    ...
                    distance_covered = mesure_distance(start_position, end_position)
